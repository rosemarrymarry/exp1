...
from bitonic_filter import bitonic_median_filter_tiled
...
def main() -> None:
    ...
    total = len(image_paths) * len(args.sigmas) * len(args.ksizes)
    done = 0
    ...
    for img_path in image_paths:
        ...
        for sigma in args.sigmas:
            ...
            for ksize in args.ksizes:
                denoised = bitonic_median_filter_tiled(noisy, ksize=int(ksize), tile_size=int(args.tile))
